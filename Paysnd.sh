...
err_fun () {
echo -e "\033[1;33m  invalid"
exit
}
clear
echo -e "\033[1;32m PAYLOAD GEN MODED BY NAZI "
echo ""
gerar_pay () {
read -p " Target HOST : " valor1
[[ -z "$valor1" ]] && err_fun
valor2="127.0.0.1"
echo ""
echo -e "\033[1;32m Request Method \033[1;37m"
echo ""
...
echo -e "\033[1;37m"
read -p " enter  Proxy: " hostprox
read -p " enter proxy Port: " portx
echo -e "\033[1;37m"
...
read -p " enter a Proxy: " hostprox
read -p " enter a Port: " portx
echo ""
